...
const Profile = () => {
    return ( <
        ...
        <
        TimeLineItem title = "Name"
        text = { resumeDetails.name }
        />{" "} <
        TimeLineItem title = "Email"
        text = { resumeDetails.email }
        />{" "} <
        TimeLineItem title = "Phone"
        text = { resumeDetails.phone }
        />{" "} <
        TimeLineItem title = "Job"
        text = { resumeDetails.jobs }
        />{" "} <
        ...
        <
        a href = "https://drive.google.com/file/d/1N6U5vPaWXnWgKQnJUyeadmr9lItLMfie/view?usp=sharing"
        target = "_blank" >
        { " " } <
